...
<style>
    ...
    <section id="wewe">
        <div class="wrapper">
            ...
            <form class="p-3 mt-3" method="POST" action="{{route('login_confirm')}}">
                @csrf
                ...
                {{-- <div class="form-field d-flex align-items-center">
                <i class="fa fa-key"></i>
                <input type="number" max=9999 min="1" name="otp" id="pwd" placeholder="OTP">
            </div> --}}
                <button type="submit" class="btn mt-3">Register</button>
            </form>
            <div class="text-center fs-6">
                <a href="/forget-password">Forget password?</a> or <a href="{{('login')}}">Login</a>
            </div>
        </div>
    </section>
@endsection
