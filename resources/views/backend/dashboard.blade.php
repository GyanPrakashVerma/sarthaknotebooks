...
<!--wrapper-->
   @php
       ...
       $cate= \App\Models\Category::all()->count();
   @endphp
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div>
                                    ...
                                    <h4 class="my-1 text-info">{{$order}}</h4>
                                    <p class="mb-0 font-13">{{$order}} Orders Recieved</p>
                                </div>
                                <div class="widgets-icons-2 rounded-circle bg-gradient-scooter text-white ms-auto"><i class="lni lni-shopping-basket"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div>
                                    ...
                                    <h4 class="my-1 text-danger">{{$product}}</h4>
                                    <p class="mb-0 font-13">+{{$product}} Product Added</p>
                                </div>
                                <div class="widgets-icons-2 rounded-circle bg-gradient-bloody text-white ms-auto"><i class='bx bx-cart'></i>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div>
                                    ...
                                    <h4 class="my-1 text-success">{{$cate}}</h4>
                                    <p class="mb-0 font-13">+{{$cate}} Category Available</p>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div>
                                    ...
                                    <p class="mb-0 font-13">+{{$customer}} Active Customers</p>
                                </div>
