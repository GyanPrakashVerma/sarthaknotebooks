     ...
     <div class="card">
        <div class="row g-0">
          <div class="col-md-4 border-end">
            <img src="{{asset('main_products/'.$product->p_mainimg)}}" class="img-fluid" alt="...">
            <div class="row mb-3 row-cols-auto g-2 justify-content-center mt-3">
                {{-- @foreach($img as $imgs)
                <div class="col"><img src="{{asset('products/'.$imgs->imageName)}}" width="70" class="border rounded cursor-pointer" alt=""></div>
                @endforeach --}}
            </div>
          </div>
          <div class="col-md-8">
            <div class="card-body">
              ...
              <div class="d-flex gap-3 py-3">
                <div class="cursor-pointer">
                  ...
                  <div class="text-success">{{$product->stock_status}}</div>
                  <div class="text-"><i class="bx bxs-cart-alt align-middle"></i> 134 orders</div>
              </div>
              <div class="mb-3"> 
                <span class="price h4">${{$product->p_price}}</span> 
